...
def get_properties(widget):
    ...
    for prop in properties:
        ...
        if resolved_name in PROPERTY_TABLE:
            resolved_properties[prop] = PROPERTY_TABLE[resolved_name]
            resolved_properties[prop]["value"] = widget[prop]
            resolved_properties[prop]["name"] = prop
        elif prop in PROPERTY_TABLE:
            resolved_properties[prop] = PROPERTY_TABLE[prop]
            resolved_properties[prop]["value"] = widget[prop]
            resolved_properties[prop]["name"] = prop
